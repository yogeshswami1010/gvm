...
export default function Home() {
 ...
 return <main><section className="hero" id="home">
  ...
  <div className="hero-copy shell"><div className="art-caption mono"><span>GANDHI VIDYA MANDIR — SARDARSHAHR, RAJASTHAN</span><span>SINCE 1950</span></div><h1>Education changes lives.<br/><em>Service shapes society.</em></h1><div className="hero-bottom"><p>Want to sell a painting or collection? You can, with the respect it deserves. PieterKoopt® keeps the painting and its story alive.</p><a className="pill light" href="#offer">Discover GVM <span>↗</span></a></div></div>
  <div className="scroll-cue mono">SCROLL TO DISCOVER <span>↓</span></div>
 </section><section data-reveal className="intro section shell" id="about"><div className="eyebrow mono">THE GVM STORY</div><div className="intro-grid"><h2>From desert land<br/>to an <em>oasis of learning.</em></h2><div><p>Founded in 1950 on 1,200 acres in Sardarshahr, GVM has grown into a home for education, health, welfare, research and rural service.</p><a className="text-link mono" href="/contact">READ MORE ABOUT GVM <span>↗</span></a></div></div></section>
...
<section data-reveal className="story section shell" id="stories"><div className="story-art"><div className="frame"><div className="paint-stroke"/></div></div><div className="story-copy"><div className="eyebrow mono">GAU SHALA THAT LIVE ON</div><h2>A life given<br/>to <em>service</em></h2><p>Inspired by Swami Shri Ramsharanji and Gandhian ideals, GVM believes learning becomes meaningful when it uplifts people, families and communities.</p><a className="pill" href="/gaushala">Explore the GVM story <span>↗</span></a></div></section>
