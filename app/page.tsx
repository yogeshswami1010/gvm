...
<footer data-reveal id="contact" className="site-footer"><div className="shell footer-topline"><span className="mono">GANDHI VIDYA MANDIR · SARDARSHAHR, RAJASTHAN</span><span className="mono">EDUCATION · SERVICE · HUMANITY</span></div><div className="shell footer-main"><div className="footer-identity"><a className="brand footer-brand" href="#home">GVM<sup>®</sup></a><p>Learning, service and human values—working together for generations.</p><a className="footer-support mono" href="/support-us">SUPPORT OUR CAUSE <b>↗</b></a></div><div className="footer-column"><span className="mono">EXPLORE</span><a href="#home">Home</a><a href="/about">About GVM</a><a href="/activities">Activities</a><a href="/gaushala">Gau Shala</a></div><div className="footer-column"><span className="mono">CONNECT</span><a href="/bal-griha">Bal Griha</a><a href="/team">Our Team</a><a href="/contact">Contact</a><a href="/support-us">Support GVM</a></div><div className="footer-column footer-contact"><span className="mono">CENTRAL OFFICE</span><a href="mailto:gvmcentraloffice@gmail.com">gvmcentraloffice@gmail.com</a><a href="tel:+911564220025">01564-220025</a><p>Sardarshahr, Churu<br/>Rajasthan 331401, India</p></div></div><div className="shell footer-bottom mono"><span>© 2026 GANDHI VIDYA MANDIR</span><span>MADE FOR A LIFE OF SERVICE</span></div></footer>
